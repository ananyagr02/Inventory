...
const bcrypt=require('bcryptjs')
    ...
    exports.register=catchAsync(async(req,res)=>{
        try {
            const {name,email,phoneNumber,role,password,passwordConfirm,warehouseId}=req.body;
            ...
            const userCreated=await User.create({name,email,phoneNumber,role,password,passwordConfirm,warehouseId})
